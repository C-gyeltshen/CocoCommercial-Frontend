    ...
    return (
        ...
        <main className="flex-grow container mx-auto px-4 py-8">
            ...
            <div className="text-center mb-12">
                ...
                Log in to manage your store and grow your business.
                </p>
            </div>
            ...
            <div className="text-center mb-12">
                ...
                Access your Coco Commercial account and stay connected with your customers.
                </h1>
            ...
            <div className="mb-8">
                ...
                <button
                    onClick={() => router.push('/auth/loginAsMerchant')}
                ...
                <button
                    onClick={() => router.push('/auth/loginAsCustomer')}
                    className={`p-6 rounded-lg border-2 transition-all duration-300 ${
                    userType === "customer"
                        ? "border-[#1B4965] bg-blue-50"
                        : "border-gray-200 hover:border-[#1B4965]"
